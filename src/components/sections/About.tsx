...
            1s Labs was founded with a vision to bridge the gap between technology and business success. By offering highly affordable solutions, we make it possible for any business to embrace digital systems that boost efficiency and growth. Over the past year, we’ve helped several small and medium enterprises (SMEs) take their first steps into the digital world.
            </p>
          </motion.div>
...
                <p>
                  Our journey began with the frustration we felt as digital developers seeing so many local businesses with untapped potential that could be unlocked through digital transformation. From that passion, we have grown into a full-service digital agency that combines quality, creativity, and affordability.
                </p>
                <p>
                  We’ve had the opportunity to work with startups, SMEs, and corporate clients across diverse industries, delivering solutions that truly make an impact.
                </p>
               <p>
  Our approach blends technical expertise with creative thinking, ensuring that every solution we build not only meets your current needs but also adapts to your future growth.
               </p>
               <p>
                Today, we’re proud to be a trusted partner for businesses looking to achieve real results in the digital era.
               </p>
              </div>
            </motion.div>
            
...
                <div className="text-3xl font-semibold text-neutral-900 dark:text-white mb-6">Use Forever.</div>
